...
function deletePublishedMsg() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, client.publish.deleteMany()];
        });
    });
}
function deleteMsgById(incomingId) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
...
exports["default"] = {
    create: create,
    deletePublishedMsg: deletePublishedMsg,
    deleteMsgById: deleteMsgById,
    getAll: getAll
};
